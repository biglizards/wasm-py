...
extern PyLongObject small_ints[];
#define SMALL_INT(x) small_ints[NSMALLNEGINTS + x]

static inline PyObject* __PyLong_GetSmallInt_internal(int value) {
    // assert(-_PY_NSMALLNEGINTS <= value && value < _PY_NSMALLPOSINTS);
    size_t index = NSMALLNEGINTS + value;
    PyObject *obj = (PyObject*) &small_ints[index];
    return obj;
}
...
// todo: if we add subclassing, restore this
