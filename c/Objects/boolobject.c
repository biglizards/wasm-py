...
// this is so you can do type(x)(1) to make a new bool (if x is a bool)
// well I guess strictly `bool` is a type not a builtin function
//static PyObject *
...
// minor concern for bools: they subclass int
// and so far everything has been assuming the absence of subclassing
// this means two things: 1. we just re-implement a load of methods (eg comparison methods) for bools
// 2. we implement a limited form of subclassing
